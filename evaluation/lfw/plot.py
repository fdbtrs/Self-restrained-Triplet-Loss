...
#target folder
roc_path = './newplots/roc_log_cos_um'
table_path = "./newplots/tables_cos_um"
#models'similarities_cosine/ResNet50',
models = [ 'lfw/lfw_comparsion_mobilefacenet','lfw/lfw_comparsion_Resnet50','lfw/lfw_comparsion_Resnet100']
...
# iterate over models
for model in models:
    if  'mobilefacenet' in model:
        model_name = "Mobilefacenet"
        model_type="Mobilefacenet"
    elif  'lfw_comparsion_Resnet100' in model:
        model_name = "ResNet100"
        model_type="ResNet100"
    else:
        model_name = "Resnet50"
        model_type="ResNet50"
    ...
    plot_name = "_lfw_%s_" % model_type + "Baseline"
    plot.plt_roc_curve(all_stats, plot_names, save_path="/", dpi=1200, ext=plot_name + '.pdf')
        
    plot_name = "_lfw_%s_" % model_type + "Baseline_Distribution"
